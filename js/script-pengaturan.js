...
if (inputBgLogin) {
    inputBgLogin.addEventListener('change', async function(e) {
        ...
        try {
            ...
            // Update cache agar halaman login langsung pakai background baru
            localStorage.setItem('cached_bg_login', base64Data);
...
window.hapusBgLogin = async function() {
    ...
    // Hapus cache background
    localStorage.removeItem('cached_bg_login');
